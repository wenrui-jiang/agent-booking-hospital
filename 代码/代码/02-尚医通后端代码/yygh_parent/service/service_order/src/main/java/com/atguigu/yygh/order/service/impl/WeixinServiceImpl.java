...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map createNative(Long orderId) {
        try {
            ...
            paramMap.put("notify_url", System.getProperty("yygh.weixin.notify-url", System.getenv().getOrDefault("YYGH_WEIXIN_NOTIFY_URL", "http://localhost/api/order/weixinPay/weixinNotify")));
