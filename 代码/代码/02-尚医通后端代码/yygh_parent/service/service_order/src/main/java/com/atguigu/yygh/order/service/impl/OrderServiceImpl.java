...
public class OrderServiceImpl extends
    ...
    @Value("${yygh.order.mock-hospital-submit:false}")
    private boolean mockHospitalSubmit;
    ...
    public Long saveOrder(String scheduleId, Long patientId, Long userId) {
        ...
        if (mockHospitalSubmit) {
            orderInfo.setHosRecordId("MOCK-" + orderInfo.getId());
            orderInfo.setNumber(1);
            orderInfo.setFetchTime("就诊当日开诊前30分钟");
            orderInfo.setFetchAddress("门诊楼一层挂号/收费窗口（本地演示）");
